import CMCpriceConverter from "../../components/PageInfo/priceConverter";
...
const Currencies = () => {
  const [coinName, setCoinName] = useState<string | null | undefined>();
  const [coinSymbol, setCoinSymbol] = useState<string | null | undefined>();
